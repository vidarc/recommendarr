...
See **`docs/superpowers/BACKLOG.md`** for current redesign phases (B3–B7) and **`docs/superpowers/HISTORY.md`** for shipped phases. Don't duplicate the list here — the BACKLOG file is authoritative.
